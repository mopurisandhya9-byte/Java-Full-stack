...
.addEventListener("submit",function(event)
{
    ...
    let genderSelection = document.querySelector('input[name="gender"]:checked');
    let Gender = genderSelection ? genderSelection.value : "Not selected";
    ...
    document.getElementById("p7").innerText="Documents:"+ (Documents.length ? Documents.join(", ") : "None");
